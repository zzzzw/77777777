...
<html>
  <head>
   	<meta charset="utf-8" />
		...
		<link href="<%=basePath%>/resource/media/css/bootstrap.min.css"
		...
		<div class="header navbar navbar-inverse navbar-fixed-top">
			...
			<div class="navbar-inner">
				...
				<div class="container-fluid">
					...
					<a class="brand" href="#"
						style="color: white; font-size: 22;"> &nbsp;&nbsp;&nbsp;Holy
						Airplane </a>
					...
					<a href="javascript:;" class="btn-navbar collapsed"
						data-toggle="collapse" data-target=".nav-collapse"> <img
							src="<%=basePath%>/resource/media/image/menu-toggler.png" alt="" />
					...
					<ul class="nav pull-right">
							...
							<ul class="dropdown-menu extended inbox">
								...
								<li>
									...
									<a href="inbox.html?a=view"> <span class="photo"><img
												src="<%=basePath%>/resource/media/image/avatar2.jpg" alt="" />
									</span> <span class="subject"> <span class="from">Lisa
												Wong</span> <span class="time">Just Now</span> </span> <span
										class="message"> Vivamus sed auctor nibh congue nibh.
											auctor nibh auctor nibh... </span> </a>
								...
								<li>
									...
									<a href="inbox.html?a=view"> <span class="photo"><img
												src="<%=basePath%>/resource/media/image/avatar3.jpg" alt="" />
									</span> <span class="subject"> <span class="from">Richard
												Doe</span> <span class="time">16 mins</span> </span> <span class="message">
								...
								<li>
									...
									<a href="inbox.html?a=view"> <span class="photo"><img
												src="<%=basePath%>/resource/media/image/avatar1.jpg" alt="" />
									</span> <span class="subject"> <span class="from">Bob
												Nilson</span> <span class="time">2 hrs</span> </span> <span
										class="message"> Vivamus sed nibh auctor nibh congue
											nibh. auctor nibh auctor nibh... </span> </a>
							...
							<ul class="dropdown-menu extended tasks">
								...
								<li>
									...
									<a href="#"> <span class="task"> <span class="desc">New
												release v1.2</span> <span class="percent">30%</span> </span> <span
										class="progress progress-success "> <span
								...
								<li>
									...
									<a href="#"> <span class="task"> <span class="desc">Application
												deployment</span> <span class="percent">65%</span> </span> <span
								...
								<li>
									...
									<a href="#"> <span class="task"> <span class="desc">Mobile
												app release</span> <span class="percent">98%</span> </span> <span
										class="progress progress-success"> <span
								...
								<li>
									...
									<a href="#"> <span class="task"> <span class="desc">Database
												migration</span> <span class="percent">10%</span> </span> <span
										class="progress progress-warning progress-striped"> <span
											style="width: 10%;" class="bar"></span> </span> </a>
								...
								<li>
									...
									<a href="#"> <span class="task"> <span class="desc">Web
												server upgrade</span> <span class="percent">58%</span> </span> <span
										class="progress progress-info"> <span
								...
								<li>
									...
									<a href="#"> <span class="task"> <span class="desc">Mobile
												development</span> <span class="percent">85%</span> </span> <span
										class="progress progress-success"> <span
						...
						<li class="dropdown user">
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img
									alt=""
									src="<%=basePath%>/resource/media/image/avatar1_small.jpg" />

								<span class="username">zengzhiwei</span> <i
