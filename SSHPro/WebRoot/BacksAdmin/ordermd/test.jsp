    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
            ...
            <div data-scrollbar="true" data-height="100%">
                ...
                <ul class="nav">
                    <li class="nav-profile">
                        <div class="image">
                            <a href="javascript:;">
                                <img src="<%=basePath %>/BacksAdmin/assets/img/user-13.jpg" alt="" /></a>
                        </div>
                        <div class="info">
                ...
                <ul class="nav">
                    <li class="has-sub ">
						...
						<ul class="sub-menu">
						    <li ><a href="index.html">主控面板v1</a></li>
						    <li ><a href="index_v2.html">主控面板v2</a></li>
						</ul>
					</li>
					<li class="has-sub">
						<a href="javascript:;">
						...
						<ul class="sub-menu">
						    <li >
						    <a href="<%=basePath %>/BacksAdmin/plane/search.jsp">查询</a>
						    </li>
						    <li><a href="#">增加</a></li>
						</ul>
					</li>
        ...
        <div id="content" class="content">
            ...
            <ol class="breadcrumb pull-right">
                ...
                <li><a href="javascript:;">XX管理</a></li>
                <li class="active">xx</li>
            </ol>
            <!-- end breadcrumb -->
            <!-- begin page-header -->
            <h1 class="page-header">
              XX管理 <small>以下是所有XX信息...</small></h1>
            <!-- end page-header -->
            <!-- begin row -->
            <!-- begin row -->
			<div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title"> - Default</h4>
                        </div>
