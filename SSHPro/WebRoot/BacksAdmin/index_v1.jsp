...
<body>
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
						    <li class="active"><a href="index.html">主控面板v1</a></li>
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
						    <li ><a href="./plane!czfj.action">查询</a></li>
						    <li><a href="<%=basePath%>BacksAdmin/plane/add.jsp">增加</a></li>
						</ul>
					</li>
					<li class="has-sub">
						<a href="javascript:;">
	...
	<script src="<%=basePath%>BacksAdmin/assets/js/dashboard.min.js"></script>
