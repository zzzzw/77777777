...
<body  onload="showLeftTime()">
              ...
              <div class="panel panel-inverse">
			    ...
			    <div class="panel-body">
			     <div class="table-responsive">                           
                                ...
                                <div >
						             <form action="order1!shenhes.action" method="post" id="hkgslist">						
							         <input type="hidden" name="ajaxtext" value="" id="1"/>
							         <input type="submit" id="submit" value="批量审核" class="btn btn-danger" >
									 </form>
								</div>	
                            </div>                                           
                        </div>
    ...
    <script src="<%=basePath %>/BacksAdmin/order_approve/js/js.js"></script>
