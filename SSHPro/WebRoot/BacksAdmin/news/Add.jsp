	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<h1 class="page-header">
				增添员工 <small>请小心操作</small>
			</h1>
			<!-- end page-header -->


	<form action="news-manager!Add.action" method="post" enctype="multipart/form-data">
       <div>
           <font size="4" class="text-primary  "> <b>新闻标题：</b></font> 
           <input type="text"  name="entity.title"  class="  form-control "  placeholder="请输入新闻标题..."  required/>
           
           <font size="4" class="text-primary  "> <b>编辑者：</b></font> 
           <input type="hidden" name="entity.author" value="${ session.user.name}"/>
           <!-- 
           <input type="text"  name="entity.author"  class="  form-control "  placeholder="请输入新闻编辑者..."  required/>
            -->
            <input type="text"  name="entity.author"  class="  form-control "  value="${session.user.account}" style="border:none" disabled/>
                 
           <font size="4" class="text-primary  "> <b>发布日期：</b></font> 
        <!--    <input type="date"  name="entity.pubdate"  class="  form-control "    required/> -->
           <input type="text" value="发布日期为系统时间，请注意新闻编辑时间。"  class="  form-control "   style="border:none" disabled/><br>
           
           <span class="text-primary "><font size="4"><b>新闻内容：</b></font> </span>
           <font size="1">
           <textarea rows="20%" cols="70%" name="entity.content" class="text-info    form-control " placeholder="此处输入新闻内容..."  required>
           </textarea>
           </font>
           
             <font size="4" class="text-primary  "> <b>新闻插图：</b>
        	   <input type="file"  name="myFile"      accept="image/*"/>
        	   </font> 
        	   
             <font size="4" class="text-primary  "> <b>新闻类型：</b></font> 
            <select name="entity.type" class="type  form-control" >
       ...
       <input type="submit" class=" btn btn-danger"  value="确定发布新闻"  >  <!--  onclick="return checkfun();" -->
      </div>
	</form>
