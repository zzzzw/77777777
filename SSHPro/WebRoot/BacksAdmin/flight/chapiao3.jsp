               ...
               <div class="panel panel-inverse">
			    <div class="panel-heading">
			        <div class="panel-heading-btn">
						...
						<label class="control-label" for="input01" style="font-weight:bold;font-family : 微软雅黑,宋体; " >
							  <h3>
										应付金额为：
										<strong class="text-danger">${price1}</strong>元
							 </h3>
						</label>	
					    ...
					    <div class="panel-body">
									...
									<form action="line1!fukuan.action" method="post">
