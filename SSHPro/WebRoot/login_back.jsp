        ...
        <div class="login login-v2" data-pageload-addclass="animated flipInX">
         ...
         <form action="employee!Login.action" method="POST" class="margin-bottom-0" id="signupForm">  
             ...
             <!--                <span id="messagename"  style="color:red">对不起，不存在该账号。</span>   -->
                    ...
                    <div class="form-group m-b-20">
                        <input type="password" id="password" name="entity.psw"  class="form-control input-lg required "  onpaste="  alert('对不起，不支持密码粘贴功能，请逐个输入。');   return false;"   placeholder="Password" />
