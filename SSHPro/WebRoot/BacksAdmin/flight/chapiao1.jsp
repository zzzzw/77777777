...
<body  onload="showLeftTime()">
        ...
        <!-- begin #content -->
            ...
            <ol class="breadcrumb pull-right">
                ...
                <li class="active">查票结果</li>
            </ol>
            <!-- end breadcrumb -->
            <!-- begin page-header -->
            <h1 class="page-header">
                                查票管理 <small>以下是所有查票信息...</small></h1>
            <!-- end page-header -->
			...
			<h3 class="text-right">
				<a href="<%=basePath %>/BacksAdmin/flight/chapiao.jsp" class="btn btn-info">重新查询</a>
			</h3>
			<h5>
				你当前选择的始发站是：<i class="glyphicon glyphicon-plane"></i>
				<strong >${sfz}</strong> ,到达站是：
				<i class="glyphicon glyphicon-plane"></i><strong >${ddz}</strong>
			</h5>
		...
		<!-- begin panel -->
                            ...
                            <div class="table-responsive">
                                <table id="table_id" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                         ...
                                         <tr>
		        <td>
		        <i class="glyphicon glyphicon-plane"></i><s:property value="#u[1]" /><br>    
		        ...
		        <td>		  
				<input type="submit" value="预定" id="yuding" class="btn btn-info">	
	...
	<script src="<%=basePath%>/BacksAdmin/flight/js/js.js"></script>
    <!-- ================== END PAGE LEVEL JS ================== -->
