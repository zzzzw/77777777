	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">删除员工信息</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">删除员工信息 <small>批量删除中······</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">人员管理--之--删除员工信息</h4>
                        </div>
                        <div class="alert alert-info fade in">
                            <button type="button" class="close" data-dismiss="alert">
                                <span aria-hidden="true">&times;</span>
                            </button>
                          这是删除员工信息页面，可批量删除，请小心操作。
                        </div>
                        
                   
                        <div class="panel-body">
                            <div class="table-responsive">
                            	<form action="employee!Delete.action" method="post" >
                                <table id="data-table1" class="table table-striped table-bordered nowrap list" width="100%">
                                <thead>
									<tr>
										   <th>ID号</th>
								            <th>账号</th>
									...
									<tbody>
							         ...
							         <tr class="gradeA">
							    		  <td>
							    		    <input type="checkbox" id="${u.id}" class="checking" name="checking" value="${u.id}">
							    		 		  ${u.id }
							    		   </td>
							       		 <td>${u.account}</td>
							       		 <td> ${u.psw }</td>
